          ...
          <div className="goals-card">
            ...
            <div className="goal-item">
              <div className="goal-icon">
                ...
                <svg width="64" height="64" fill="none" viewBox="0 0 64 64">
                  ...
                  <path
                    d="M32 18v-8M32 46v8M18 32h-8M46 32h8"
                    stroke="#fff"
                    strokeWidth="3"
                  />
              ...
              <div>
                ...
                <p className="goal-desc">
                  Menantang para siswa/mahasiswa Indonesia untuk membuat sebuah
                  karya yang bisa diaplikasikan dan bermanfaat secara langsung
                  pada masyarakat.
                </p>
              </div>
            </div>
            ...
            <div className="goal-item">
              ...
              <div>
                ...
                <p className="goal-desc">
                  Mengajak para siswa/mahasiswa Indonesia untuk lebih peka
                  terhadap permasalahan di lingkungan masing-masing dan mencari
                  solusinya.
                </p>
              </div>
            </div>
